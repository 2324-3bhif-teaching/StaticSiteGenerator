...
export class ElementStyleService extends ServiceBase{
    ...
    public async selectAllElementStyles(id: number){
    ...
    public async insertElementStyle(elementStyle: ElementStyleData){
